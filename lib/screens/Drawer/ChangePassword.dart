...
class _ChangePasswordPageState extends State<ChangePasswordPage> {
  ...
  Future<void> updatePassword() async {
    ...
    var request = http.MultipartRequest(
      'POST',
      Uri.parse('http://151.106.17.246:8080/OMCS-CMS-APIS/update/update_users_password.php'),
    );
          ...
          child: Column(
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  SharedPreferences prefs = await SharedPreferences.getInstance();
                  var old_pass = prefs.getString("description");
                ...
                child: Text(
                  'Change Password', style: TextStyle(color: Constants.primary_color),),
              ),
            ],
          ),
        ),
