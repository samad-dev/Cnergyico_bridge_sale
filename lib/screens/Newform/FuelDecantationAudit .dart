...
class FuelDecantationAudit extends StatefulWidget {
  ...
  const FuelDecantationAudit({Key? key, this.dealer_id, this.inspectionid,this.dealer_name,this.formId, this.header}) : super(key: key);

  @override
  FuelDecantationAuditState createState() => FuelDecantationAuditState();
}

class FuelDecantationAuditState extends State<FuelDecantationAudit> {
  int activeStep = 0;
  List<CaseData> cases = [];
  ...
  void initState() {
    super.initState();
    fetchData();
    print("pcc insepction page ${widget.header}");
  }
  ...
  Future<void> fetchData() async {
    final response = await http.get(Uri.parse(
        'http://151.106.17.246:8080/bycobridgeApis/get/get_decant_data.php?key=03201232927'));
  ...
  Future<void> postSurveyData() async {
    ...
    String apiUrl =
        'http://151.106.17.246:8080/bycobridgeApis/create/create_decant_new.php';
    ...
    Map<String, dynamic> postData = {
      ...
      'site_name': widget.dealer_name,
      'header_name': widget.header,
  ...
  Future<void> postImages(List<Map<String, dynamic>> postDataList, List<Map<String, dynamic>> imagesToPost) async {
    String apiUrl = 'http://151.106.17.246:8080/bycobridgeApis/create/decant_detail_files.php';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Fuel Decantation Audit',
            style: GoogleFonts.montserrat(
