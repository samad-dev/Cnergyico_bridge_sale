...
class PCCForm extends StatefulWidget {
  ...
  const PCCForm({Key? key, this.dealer_id, this.inspectionid,this.dealer_name,this.formId, this.header}) : super(key: key);

  @override
  PCCFormState createState() => PCCFormState();
}

class PCCFormState extends State<PCCForm> {
  int activeStep = 0;
  List<CaseData> cases = [];
  ...
  Future<void> fetchData() async {
    final response = await http.get(Uri.parse(
        'http://151.106.17.246:8080/bycobridgeApis/get/get_pcc_data.php?key=03201232927'));
  ...
  Future<void> postSurveyData() async {
    ...
    String apiUrl =
        'http://151.106.17.246:8080/bycobridgeApis/create/create_pcc_new.php';
  ...
  Future<void> postImages(List<Map<String, dynamic>> postDataList, List<Map<String, dynamic>> imagesToPost) async {
    String apiUrl = 'http://151.106.17.246:8080/bycobridgeApis/create/pcc_detail_files.php';
