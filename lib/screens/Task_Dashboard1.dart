                        ...
                        children: [
                          Expanded(
                            child: GestureDetector(
                              ...
                              child: Card(
                                ...
                                color: resultList.isNotEmpty &&
                                    resultList[0]['Inspection'] == '1'
                                    ? Constants.secondary_color
                                    : Colors.white,
                                child: Padding(
                                  padding: const EdgeInsets.symmetric(vertical: 16.0),
                          ...
                          Visibility(
                            visible: !(resultList.isNotEmpty &&
                                resultList[0]['Stock Variations Status'] != '3'),
                            child: Expanded(
                              child: GestureDetector(
                                onTap: () {
                                  if (resultList.isNotEmpty &&
                                      resultList[0]['Stock Variations Status'] == '1') {
                                    print('Measurement Status is 1, action not allowed');
                                  } else {
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => StockVariation(
                                          dealer_id: dealer_id,
                                          inspectionid: inspectionid!,
                                          dealer_name: dealer_name!,
                                        ),
